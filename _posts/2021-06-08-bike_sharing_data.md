...
We will need the derivative of the output activation function ($f(x) = x$) for the backpropagation implementation. If you aren't familiar with calculus, this function is equivalent to the equation $y = x$. What is the slope of that equation? That is the derivative of $f(x)$.
...
## Unit tests
Run unit tests to check the correctness of your network implementation. This will help us be sure our network was implemented correctly before we starting trying to train it.
```python
import unittest
